...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    NEOPLATINUM("neoplatinum", 500, new int[]{ 4, 8, 6, 4 }, 12,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3.5f, .5f, () -> Ingredient.of(ModItems.NEOPLATINUM.get())),
    ...
    public String getName() {
        return PlatinumMod.MOD_ID + ":" + this.name;
    }
